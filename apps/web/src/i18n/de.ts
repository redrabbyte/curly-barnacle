...
export const de: Catalogue = {
  ...
  'activity.comment': 'hat kommentiert',
  'activity.attachment.added': 'hat ein Foto hinzugefügt',
  'activity.attachment.removed': 'hat ein Foto entfernt',
  'activity.attachment.restored': 'hat ein Foto wiederhergestellt',
  'change.description': 'von „{from}“ in „{to}“ umbenannt',
  'change.amount': 'Betrag {from} → {to}',
  'change.category': 'Kategorie {from} → {to}',
  'change.date': 'Datum {from} → {to}',
  'change.note.added': 'Notiz hinzugefügt',
  'change.note.changed': 'Notiz geändert',
  'change.note.removed': 'Notiz entfernt',
  'change.splitMode': 'Aufteilung {from} → {to}',
  'change.whoPays.added': '{names} zur Aufteilung hinzugefügt',
  'change.whoPays.removed': '{names} aus der Aufteilung entfernt',
  'change.shares': 'geändert, wer was schuldet',
  'split.equal': 'gleichmäßig',
  'split.exact': 'nach genauen Beträgen',
  'split.percent': 'nach Prozent',
  'split.shares': 'nach Anteilen',
