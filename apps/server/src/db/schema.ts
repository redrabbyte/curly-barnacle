...
export const groups = mysqlTable('groups', {
   ...
   * There is no readable one: 0009 moved it here and 0010 dropped the column.
   *
   ...
   */
  nameEpoch: int('name_epoch').notNull(),
  nameIv: varchar('name_iv', { length: 32 }).notNull(),
  nameCt: varchar('name_ct', { length: 768 }).notNull(),
