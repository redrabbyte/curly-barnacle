...
describe('sealed tables hold no readable content', () => {
  ...
  it('groups carry their name sealed and nothing readable', () => {
    ...
    // like every wrap. The readable `name` went with 0010, and a group cannot
    // exist without the sealed one.
    ...
    for (const column of [schema.groups.nameEpoch, schema.groups.nameIv, schema.groups.nameCt]) {
